...
function StaffPrograms_report() {
    ...
    const searchFilteredRescueDetails = staffprogramms_details.filter((item) => {
    ...
    const handleDelete = async (id) => {
        try {
            ...
            const res = await apiRoute.delete(`/remove/StaffProgramtoRecycleBin/${id}`);
                ...
                <Container>
                    <Form>
                        ...
                        <Form.Group as={Row} className='mb-3'>
                            ...
                            <Col sm="7">
                                {Array.isArray(files.staff_photos) && files.staff_photos.length > 0 ? (
