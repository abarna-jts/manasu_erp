...
function Reunited_people() {
    ...
    const getRescueDetails = async () => {
        try {
            const response = await apiRoute.get('/admision/get_reunionPeople');
            ...
            <div className="d-xl-flex justify-content-between align-items-center flex-wrap flex-md-nowrap text-start py-2">
                <div className="d-block mb-4 mb-xl-0 px-4 ">
                    <Breadcrumb className="d-none d-md-inline-block mb-0" listProps={{ className: "breadcrumb-dark breadcrumb-transparent" }}>
                        ...
                        <Breadcrumb.Item active>Reunion Details</Breadcrumb.Item>
                    </Breadcrumb>
                    <h6 className="breadcrumb_title">Reunion Details</h6>

                </div>
                <Col md={4} className="text-start">
                    <h3 className="section_title text-center px-4">Reunited Resident Details</h3>
                </Col>
...
export default Reunited_people
