...
const { createForm2 ,createForm2A,createForm2B, createForm2C,getForm2APDF,getForm2BPDF, getForm2CPDF} = require("../controllers/scrb_form");
...
//pdf file get
router.get('/get_scrb_formdata/:admissionNumber', getForm2APDF);
